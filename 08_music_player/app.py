...
play_layout = [
    [sg.VPush()],
    [sg.Push(), sg.Text(song_name, font = 'Arial 20', key = '-SONG-'), sg.Push()],
    [sg.VPush()],
    [
        sg.Push(),
        sg.Button(image_data=play_image, button_color = 'white', border_width = 0, key = '-PLAY-'),
        sg.Text(''),
        sg.Button(image_data=pause_image, button_color = 'white', border_width = 0, key = '-PAUSE-'),
        sg.Push()
    ],
    [sg.VPush()],
